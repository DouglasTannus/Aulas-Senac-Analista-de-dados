# A Delegacia de Roubos e Furtos de Automóveis (DRFA) por meio do seu Delegado Titular entrou em contato com você e solicitou que fosse realizado um levantamento acerca dos registros de Roubos de Automóveis(roubo_veiculo) por Delegacias(cisp). O objetivo principal é verificar a existência de valores que estejam muito acima ou muito abaixo da média.
