# O Secretário de Segurança Pública do Rio de Janeiro entrou em contato com você de forma urgente, pois precisa apresentar para o Governador do Estado do Rio de Janeiro um Relatório sobre os índices de Recuperação de Veículos (recuperacao_veiculos) por Batalhão de Polícia Militar (aisp). O objetivo principal é verificar a existência de valores que estejam muito acima ou muito abaixo da média.
